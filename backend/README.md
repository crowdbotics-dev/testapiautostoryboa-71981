...
## Project Structure
    ...
    ├── testapiautostoryboa_71981  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_71981`
...
2. Clone this repo and `cd testapiautostoryboa_71981`
